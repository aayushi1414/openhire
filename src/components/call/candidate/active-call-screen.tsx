...
export function ActiveCallScreen(Props: ActiveCallScreenProps) {
  ...
  return (
    <div className="w-full max-w-6xl py-8">
      <Card className="w-full overflow-hidden rounded-md border-2 border-border border-r-4 border-b-4 bg-card py-0">
        {/* Card header */}
        <div className="border-border border-b p-6">
          {/* Row 1: Title + End Interview button */}
          <div className="mb-3 flex items-center justify-between gap-4">
            <h2 className="font-bold text-xl md:text-2xl">{interview?.name}</h2>
            <ConfirmDialog
              trigger={
                <Button
                  variant="outline"
          ...
          <div className="mb-4 flex flex-wrap items-center gap-2">
            {interview.logoUrl && (
              <div className="flex items-center gap-1.5 rounded-full bg-muted px-3 py-1 font-medium text-xs">
                <Image
            ...
            <div className="flex items-center gap-1.5 rounded-full bg-primary/10 px-3 py-1 font-medium text-xs">
        ...
        <div className="grid grid-cols-1 gap-4 p-6 md:grid-cols-2">
          ...
          <div className="flex flex-col items-center gap-3 rounded-lg border border-border p-5">
            ...
            <div
              ...
              className="scrollbar-thin wrap-break-words h-45 w-full overflow-y-auto overflow-x-hidden text-sm leading-relaxed md:text-base"
            >
              {lastUserResponse || (
        ...
        {/* Footer branding */}
        <div className="flex items-center justify-center border-border border-t py-4">
