    ...
    steps: [
      {
        ...
        blocks: [
          {
            type: "code",
            code: "git clone https://github.com/brijeshmarch16/openhire.git\ncd openhire\npnpm install",
          },
        ],
      },
      {
        ...
        blocks: [
          ...
          },
          {
            ...
            rows: [
              ...
              },
              {
                ...
                value: [
                  { type: "text", value: "Your Postgres connection string (for example, from " },
          ...
          },
          {
            ...
            parts: [
              ...
              { type: "inlineCode", value: "NEXT_PUBLIC_MARKETING_ENABLED=true" },
              { type: "text", value: " to enable the marketing landing page." },
            ],
          },
        ],
      },
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        blocks: [
          { type: "code", code: "pnpm db:migrate && pnpm db:seed && pnpm build" },
          {
            type: "paragraph",
            parts: [
              { type: "text", value: "In " },
              { type: "strong", value: "Settings → Build & Development Settings" },
